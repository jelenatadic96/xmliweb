...
public class SmestajnaJedinica {
    ...
    @OneToMany(mappedBy = "smestajnaJedinica")
    private List<SpojAgentSmestaj> spojeviSaAgentima;
    
    public SmestajnaJedinica() { }
    
	public SmestajnaJedinica(SmestajnaJedinicaDTO smestajDTO) {
    	this.id = smestajDTO.getId();
	...
	public List<SpojAgentSmestaj> getSpojeviSaAgentima() {
		return spojeviSaAgentima;
	}

	public void setSpojeviSaAgentima(List<SpojAgentSmestaj> spojeviSaAgentima) {
		this.spojeviSaAgentima = spojeviSaAgentima;
	}
